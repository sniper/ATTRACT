...
int Texture2::ImageLoad(const char *filename, Image *image) {
	FILE *file;
...
void Texture2::init()
{
	Texture2::Image *image0 = (Texture2::Image *)malloc(sizeof(Texture2::Image));
	if(image0 == NULL) {
		printf("Error allocating space for image");
	}
	if(!Texture2::ImageLoad(filename.c_str(), image0)) {
